...
ui <- fluidPage(
  ...
  navbarPage("Regresión lineal",
             ...
             tabPanel("Bases pre cargadas",
                      sidebarLayout(
                        ...
                        sidebarPanel(
                          #Titulo
                          titlePanel("Selección de data set"),
                        ...
                        mainPanel(
                          tabsetPanel(
                            tabPanel("Exploración de data sets",
                                     fluidRow(
                                       column(6,
                                              h4("Correlación de las variables selecionadas:"),
                                       ),
                                       column(3,
                                              tableOutput("cor"),
                                       ),
                            ...
                            tabPanel("Residuales",
                                     ...
                                     fluidRow(
                                       ...
                                       column(8,
                                              h3("Gráfica de normalidad"),
                                              plotOutput("plotNormResi"),
                                              h3("Gráfica de varianza"),
                                              plotOutput("plotVarianza"),
                                       ),
                                       
                                       column(4,
                                              h3("Pruebas de hipótesis"),
  ...
  tabPanel("Datos propios",
           sidebarLayout(
             ...
             mainPanel(
               tabsetPanel(
                 tabPanel("Exploración del data set",
...
server <- function(input, output, session) {
  ...
  output$var_niv<-renderUI({
    selectInput("ig_niv", label = "Mostrar gráfica con respecto a:",input$varx_M)
  })
  ...
  output$var_ErroresEx<-renderUI({
    selectInput("E_v_exp", label = "Mostrar gráfica con respecto a:",input$varx_M)
  })
  ...
  output$var_niv_p<-renderUI({
    selectInput("ig_niv_p", label = "Mostrar gráfica con respecto a:",input$varx_M_p)
  })
  ...
  output$var_ErroresEx_p<-renderUI({
    selectInput("E_v_exp_p", label = "Mostrar gráfica con respecto a:",input$varx_M_p)
  })
